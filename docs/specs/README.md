...
| 55 | [Sheet delete and rename through one door](55-sheet-lifecycle-one-door.md) | Arch · **Defect (4 executed, ~9 read)** · Behaviour change (`!`) | L | Proposed (54 merged; needs parser 4.0.0; **owner's Excel fixtures** gate tasks 3, 5, 6) | Single owner; task 0 is in the parser fork; after 44, before 48 |
