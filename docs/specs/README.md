...
| 55 | [Sheet delete and rename through one door](55-sheet-lifecycle-one-door.md) | Arch · **Defect (4 executed, ~9 read)** · Behaviour change (`!`) | L | 🟡 Part 1 merged ([#495](https://github.com/XLibur/XLibur/pull/495) `56c80a3f`); part 2 in review ([#500](https://github.com/XLibur/XLibur/pull/500)); task 5's validation waits for spec 44 | Single owner; task 0 is in the parser fork; after 44, before 48 |
