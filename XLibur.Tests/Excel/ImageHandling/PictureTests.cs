...
public class PictureTests
{
    ...
    public void CanAddPictureFromStream()
    {
        ...
        using var resourceStream = Assembly.GetAssembly(typeof(XLibur.Examples.BasicTable)).GetManifestResourceStream("XLibur.Examples.Resources.SampleImage.jpg");
    ...
    public void CanScaleImage()
    {
        ...
        using var resourceStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("XLibur.Tests.Resource.Images.ImageHandling.png");
