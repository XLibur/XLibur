...
internal static class ChartGoldenCorpus
{
    ...
    /// <summary>
    /// The committed chart fixtures, regenerated with <c>XLIBUR_WRITE_CHART_GOLDEN=1</c>.
    /// </summary>
    internal static readonly GoldenCorpus Corpus =
        new("Excel/Charts/Golden", "XLIBUR_WRITE_CHART_GOLDEN");
}
