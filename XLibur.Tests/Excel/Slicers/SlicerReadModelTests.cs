...
public class SlicerReadModelTests
{
    ...
    public async Task Reading_a_slicer_leaves_its_part_byte_for_byte_identical()
    {
        ...
        var beforeCache = original.PartBytes("xl/slicerCaches/slicerCache1.xml");
        ...
        await Assert.That(saved.PartBytes("xl/slicerCaches/slicerCache1.xml")).IsEquivalentTo(beforeCache, CollectionOrdering.Matching);
    }
