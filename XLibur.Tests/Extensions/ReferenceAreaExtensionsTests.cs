...
internal class ReferenceAreaExtensionsTests
{
    ...
    public async Task ToSheetPoint_converts_a1_reference_to_sheet_range(ReferenceArea tokenArea, Area expectedRange)
    {
    ...
    public async Task ToSheetPoint_converts_r1c1_reference_to_sheet_range(Point anchor, ReferenceArea tokenArea, Area expectedRange)
    {
