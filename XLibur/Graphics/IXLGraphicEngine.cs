...
/// <summary>
/// An interface to abstract away graphical functionality, like reading images, fonts or to determine the width of a text.
/// </summary>
public interface IXLGraphicEngine
{
    ...
    /// <exception cref="ArgumentException">Unable to determine picture dimensions or a format doesn't match the stream.</exception>
