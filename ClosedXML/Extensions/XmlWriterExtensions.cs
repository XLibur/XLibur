...
internal static class XmlWriterExtensions
{
    ...
    public static void WriteAttributeDefault(this XmlWriter w, string attrName, bool value, bool defaultValue)
    {
    ...
    public static void WriteColor(this XmlWriter w, string elName, XLColor xlColor, bool isDifferential = false)
    {
        w.WriteStartElement(elName, OpenXmlConst.Main2006SsNs);
