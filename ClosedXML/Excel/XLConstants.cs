...
public static class XLConstants
{
    ...
    /// </remarks>
    internal static readonly Lazy<IReadOnlyList<string>> FutureFunctions = new(() =>
    [
        "ACOT",
        "ACOTH",
        "AGGREGATE",
    ...
    /// Up to date for MS-XLSX 26.1 from 2024-12-11.
    /// </remarks>
    internal static readonly Lazy<IReadOnlyList<string>> WorksheetOnlyFunctions = new(() =>
    [
        "FILTER",
        "PY",
        "SORT"
    ...
    internal static readonly Lazy<IReadOnlyDictionary<string, string>> FutureFunctionMap = new(() =>
    {
        ...
        foreach (var futureFunction in FutureFunctions.Value)
            functionsMap.Add(futureFunction, "_xlfn." + futureFunction);

        foreach (var futureFunction in WorksheetOnlyFunctions.Value)
