...
XLibur forked [ClosedXML v0.105](https://github.com/ClosedXML/ClosedXML/), then applied patches and improvements that didn't land upstream. Namespaces are prefixed with `XLibur`. Surface API is *mostly* compatible, but check the docs for details.
